...
<div class="bg-klem-blue relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-site mx-auto px-6 py-16 flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
        <div>
...
<footer class="bg-[#060e1b] text-white">
    ...
    <div class="border-t border-white/8">
        <div class="max-w-site mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
