        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
            ...
            <div class="lg:col-span-4">
                ...
                <div class="flex items-center gap-2.5">
                    <a href="#" class="w-9 h-9 rounded-lg bg-white/8 hover:bg-klem-orange flex items-center justify-center transition-colors duration-200" aria-label="LinkedIn">
                    ...
                    <a href="#" class="w-9 h-9 rounded-lg bg-white/8 hover:bg-klem-orange flex items-center justify-center transition-colors duration-200" aria-label="Twitter / X">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                    </a>
                    <a href="#" class="w-9 h-9 rounded-lg bg-white/8 hover:bg-klem-orange flex items-center justify-center transition-colors duration-200" aria-label="Facebook">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                    </a>
                    <a href="#" class="w-9 h-9 rounded-lg bg-white/8 hover:bg-klem-orange flex items-center justify-center transition-colors duration-200" aria-label="GitHub">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="lg:col-span-3">
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:+22900000000" class="text-white/50 hover:text-klem-orange transition-colors duration-150 text-sm">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:contact@klem.tech" class="text-white/50 hover:text-klem-orange transition-colors duration-150 text-sm">
    ...
    <div class="border-t border-white/8">
        <div class="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p class="text-white/30 text-xs">
                ...
                <?php esc_html_e('KLEM Technologies & Services. Tous droits réservés.', 'klem-theme'); ?>
            </p>
            <nav class="flex items-center gap-5" aria-label="<?php esc_attr_e('Liens légaux', 'klem-theme'); ?>">
                <a href="#" class="text-white/30 hover:text-white/60 transition-colors text-xs"><?php esc_html_e('Mentions légales', 'klem-theme'); ?></a>
                ...
                <a href="#" class="text-white/30 hover:text-white/60 transition-colors text-xs"><?php esc_html_e('CGU', 'klem-theme'); ?></a>
            </nav>
        </div>
    </div>
</footer>
