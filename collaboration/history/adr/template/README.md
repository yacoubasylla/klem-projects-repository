...
Emplacement (racine du monorepo) : `collaboration/history/adr/`

Format du nom de fichier réellement en usage : `AAAA-MM-JJ-titre-en-minuscules.md`

Exemple : `2026-06-18-adoption-monorepo-klem.md`

Exemple : `2026-06-18-choix-architecture-gestion-flotte.md`
